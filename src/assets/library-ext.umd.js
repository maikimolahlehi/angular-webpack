(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('test-module', ['exports', '@angular/core', '@angular/common', '@angular/router'], factory) :
    (global = global || self, factory(global['test-module'] = {}, global.ng.core, global.ng.common, global.ng.router));
    ...
    ***************************************************************************** */
    ...
    var TestModuleService = /** @class */ (function () {
        ...
        TestModuleService.ɵprov = core.ɵɵdefineInjectable({ factory: function TestModuleService_Factory() { return new TestModuleService(); }, token: TestModuleService, providedIn: "root" });
        TestModuleService = __decorate([
            core.Injectable({
                providedIn: 'root'
            })
        ], TestModuleService);
    ...
    var TestModuleModule = /** @class */ (function () {
        ...
        TestModuleModule = __decorate([
            core.NgModule({
                declarations: [TestModuleComponent],
                imports: [
                    common.CommonModule,
                    router.RouterModule.forChild([{ path: 'test', component: TestModuleComponent }]),
                ],
